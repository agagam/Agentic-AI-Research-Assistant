...
Objective:
Discover academic papers published after {last_date} specifically regarding "Arabidopsis thaliana" and focusing on "Polycomb", "lhp1", OR "H1".
...
4. **Final Response**: List the titles of the NEW articles you discovered and successfully saved during this session.
"""
...
4. Send the email to: {my_email_address}
"""
